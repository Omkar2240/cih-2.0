...
export const metadata: Metadata = {
  ...
  description: "Join the most prestigious 6-hour hackathon for college students. Innovate, build, and transform ideas into real-world solutions at GHRCEMN. Compete for a 12K+ prize pool (cash prizes and electronic gadgets).",
  ...
  openGraph: {
    ...
    description: "Join the most prestigious 6-hour student hackathon. Compete for a 12K+ prize pool — learn from mentors and build next-gen solutions at GHRCEM.",
  ...
  twitter: {
    ...
    title: "Campus Innovate Hackathon 2.0",
    description: "Innovate, build, and transform. Compete for a 12K+ prize pool and electronic gadgets at GHRCEM Nagpur.",
